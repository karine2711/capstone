$(document).ready(async function () {
    ...
    $.fn.dataTable.ext.search.push(
        function (settings, data) {
            ...
            return data[0].toLowerCase().startsWith(search.toLocaleLowerCase())
                ...
                || data[4].toLowerCase().startsWith(search.toLocaleLowerCase())
                || data[5].toLowerCase().startsWith(search.toLocaleLowerCase())
                || data[6].toLowerCase().startsWith(search.toLocaleLowerCase());
        }
    );
    ...
    let dtable = $("#myTable").DataTable({
        ...
        "infoCallback": function (settings, start, end, max, total, pre) {
            return $.i18n("list.events") + " " + +start + "-" + end + " " + $.i18n("list.from") + " " + total + $.i18n("list.form.arm");
    ...
    $('#myTable').on('click', 'tbody td a', function () {

        let text = this.textContent;
        let userName = $.trim(this.textContent);
